...
export type DownloadPaths = Record<HostPlatform, string | undefined>;

export const PLAYWRIGHT_CDN_MIRRORS = [
...
export const DOWNLOAD_PATHS: Record<BrowserName | InternalTool, DownloadPaths> =
  {
    chromium: {
      "<unknown>": undefined,
