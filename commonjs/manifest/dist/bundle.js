...
function requireSub () {
	...
	const { inspect } = require$$0__default["default"];
...
function requireArgparse () {
	...
	(function (module) {
		...
		const path = require$$4__default["default"];
 ...
 */
class AppendAction extends argparseExports.Action {
    constructor(options) {
        super(options);
...
class WorkerArgumentParser extends argparseExports.ArgumentParser {
    exit(status, message) {
