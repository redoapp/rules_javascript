...
<pre>
load("@rules_javascript//typescript:providers.bzl", "declaration_path")
...
| <a id="ts_library-compiler"></a>compiler                     | Compiler.                                                                                                     | <a href="https://bazel.build/concepts/labels">Label</a>             | optional  | `"@rules_javascript//typescript:tsc"` |
